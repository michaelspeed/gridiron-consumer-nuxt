          ...
          <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 set-flex ">
            <div class="slide-home3">
              <div class="e-slide v2 js-slider-3items">
                <div class="e-slide-img bg-gradient" v-for="mainitems of getHomePage.single.main">
                  ...
                  <div class="slide-content v2">
                    ...
                    <h3 class="v2" v-if="mainitems.type === 'variant'">{{mainitems.target.name}}</h3>
                    <h3 class="v2" v-if="mainitems.type === 'category'">{{mainitems.target.name}}</h3>
